...
* **Frameworks e Ferramentas:** Spring Boot, Spring Data JPA, Spring Security, Maven e Angular.
* **Banco de Dados:** MySQL, PostgreSQL, Oracle SQL Developer e Flyway.
* **Arquitetura e Padrões:**  Design de APIs.
  * Padrão DTO e encapsulamento de domínio.
  * Validação de dados de entrada.
  * Tratamento global de exceções.
* **Versionamento:** Git, GitHub/GitLab e GitFlow.
